...
/// @dev This contract is abstract and is intended to be inherited by dwarf.sol. State change functions are all internal which are called by other contracts functions
