...
/// @title Mead token ERC20 contract
/// @notice The mead token is the token for dwarffi. It implements the ERC20 fungible token standard. In addition it allows defined contracts to mint freshly new tokens.
